...
import 'package:fruit_e_commerce/features/Auth/presentation/widgets/Login_button_widget.dart';
          ...
          BlocConsumer<AuthBloc, AuthState>(
            listener: (context, state) {
              if (state is AuthSuccessState) {
                SnackBarMessage.showSnackBar(SnackBarTypes.SUCCESS, "logged in succussfully", context);
                ...
                SnackBarMessage.showSnackBar(SnackBarTypes.ERORR, "cant logged in", context);
              }
            },
